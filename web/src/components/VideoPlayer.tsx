...
import { PTZCrosshair } from './overlay/PTZCrosshair';
...
const VideoPlayer: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      />
      {/* PTZ Crosshair control overlay */}
      {appSettings.enablePTZCrosshair && (
        <PTZCrosshair dimensions={dimensions} currentChannel={currentChannel} />
      )}
    </div>
  );
};
